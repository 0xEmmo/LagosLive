...
// Guests who lost their ticket email can recover it with just their email + the
// order reference from their payment confirmation. The API deliberately answers
// generically whether or not a match exists — no account enumeration.
