...
export default function Splash() {
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-[#181123] transition-opacity duration-[450ms] ease-out"
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 60% at 50% 35%, rgba(85,44,183,0.35) 0%, transparent 65%), radial-gradient(ellipse 60% 55% at 70% 75%, rgba(251,125,168,0.22) 0%, transparent 65%)',
        }}
      />
      <div className="relative flex animate-splash-mark-in flex-col items-center">
        <div
          ...
          style={{
            ...
            boxShadow: '0 12px 40px rgba(85,44,183,0.5)',
          }}
        >
        ...
        <div className="mt-2 text-xs font-medium uppercase tracking-[2px] text-[#C4B8D9]">
        ...
        <div className="relative mt-10 h-[3px] w-[120px] overflow-hidden rounded-full bg-[rgba(255,255,255,0.14)]">
          <div
            ...
            style={{ background: 'linear-gradient(90deg,#552CB7,#FB7DA8)' }}
          />
        </div>
      </div>
    </div>
